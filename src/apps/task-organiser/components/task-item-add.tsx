        ...
        <div className="flex flex-col gap-2 px-2 " data-id="task-body">
          <div className="py-2">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 p-4 py-3 shadow-sm transition-all duration-300 placeholder:text-sm placeholder:italic  focus:outline-none focus:ring-2 focus:ring-slate-500"
            />
          </div>
        </div>
      </div>
